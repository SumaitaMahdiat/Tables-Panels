...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jan 03, 2025 at 10:39 PM
...
CREATE TABLE IF NOT EXISTS `bookmarks` (
  ...
  `Reader_Name` varchar(500) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `Product_Name` varchar(500) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `manga` (
  ...
  `Covers` text COLLATE utf8mb4_general_ci NOT NULL,
  `YT_Link` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`ID`),
...
CREATE TABLE IF NOT EXISTS `playlist` (
  ...
  `Song_URL` varchar(500) COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`ID`)
...
CREATE TABLE IF NOT EXISTS `reader` (
  ...
  `Type` varchar(255) COLLATE utf8mb4_general_ci DEFAULT 'Reader',
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE IF NOT EXISTS `webnovels` (
  ...
  `Covers` varchar(1000) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `YT_Link` mediumtext COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`ID`),
  UNIQUE KEY `Name` (`Name`)
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(1, 'Advent of the Three Calamities', 'Zhao Yu', '[From the Author of Author\'s POV...]  Emotions are like a drug to us.  The more we experience them, the more we become addicted.', 4.7, 0, 'A high-stakes fantasy with a dark twist.', 'Fantasy', 522, '3 calamities.jpg', 'https://www.youtube.com/embed/B8vtnVWrR64?si=crftg4ZDN1McLkzr'),
(2, 'Cultivation Online', 'Lars Lehoux', 'Yuan was born with an incurable illness that left him blind at a young age and crippled a few years later, rendering everything below his head useless. Deemed hopeless and irredeemable, his parents quickly gave up on him, and the world ignored him.  In this dark and still world, his younger sister became his sole reason for living.', 4.6, 0, 'A captivating story with online elements.', 'Fantasy', 1820, 'cultivation online.jpg', 'https://www.youtube.com/embed/q8oQHLxGWsw?si=Hv2SFfQQoMx1msEE'),
(3, 'I Was Mistaken as a Monstrous Genius Actor', 'Si Yeong', 'I, Kang Woojin, was quitting my design work and became a jobless person. The next day, my friend took me to auditions and I was forced to perform. As i was given a script, the void space appeared in my mind and forced me to relive the character. I got stabbed. Became a serial killer. Became an Exorcist. As I become an actor, the misunderstandings keeps growing day by day.', 4.5, 0, 'A hilarious yet heartfelt journey.', 'Comedy', 200, 'genius actor.jpg', 'https://www.youtube.com/embed/ox3SAwascO0?si=WHsfUBB7E17SnC-s'),
(4, 'Lord of Mysteries 2: Circle of Inevitability', 'Cuttlefish That Loves Diving', 'Sequel to Lord of Mysteries', 4.6, 1, 'A great sequel with twists and turns.', 'Fantasy', 1162, 'lord mysteries.jpg', 'https://www.youtube.com/embed/11AqozFdq9E?si=iQ4sR_Wrn--AaAFA'),
(5, 'Lord of the Mysteries', 'Cuttlefish That Loves Diving', 'With the rising tide of steam power and machinery, who can come close to being a Beyonder? Shrouded in the fog of history and darkness, who or what is the lurking evil that murmurs into our ears?  Waking up to be faced with a string of mysteries, Zhou Mingrui finds himself reincarnated as Klein Moretti in an alternate Victorian era world where he sees a world filled with machinery, cannons, dreadnoughts, airships, difference machines, as well as Potions, Divination, Hexes,', 4.8, 0, 'A complex and mind-bending story.', 'Action', 1409, 'lord of mysteries.jpg', 'https://www.youtube.com/embed/11AqozFdq9E?si=iQ4sR_Wrn--AaAFA'),
(6, 'Overgeared', 'Park Saenal', 'As Shin Youngwoo has had an unfortunate life and is now stuck carrying bricks on construction sites. He even had to do labor in the VR game, Satisfy! However, luck would soon enter his hopeless life. His character, ‘Grid’, would discover the Northern End Cave for a quest, and in that place, he would find ‘Pagma’s Rare Book’ and become a legendary class player…', 4.8, 0, 'A story of redemption and growth.', 'Action', 500, 'overgeared.jpg', 'https://www.youtube.com/embed/a0TqzhgafLg?si=UrIgl_hVxEes7pow'),
(7, 'Return of the Mount Hua Sect', 'Benguil', 'The 13th disciple of the Mount Hua Sect, one of the greatest third generation swordsmen, the Plum Blossom Sword Saint: Chung Myung. After defeating the Heavenly Demon and ending his reign of chaos, Chung Myung breathed his last on the summit of the Heavenly Demon Sect’s mountain.  Hundreds of years passed, and he was revived as a child.', 4.7, 0, 'A martial arts tale filled with tension.', 'Action', 1600, 'mount hua.jpg', 'https://www.youtube.com/embed/JYDwTQC5TlE?si=AwcKuhyXjv7gfSp_'),
(8, 'Reverend Insanity', 'Gu Zhen Ren', 'With his Three Fundamental Views* unrighteous, the demon is reborn. An old dream in the ancient days, a new author with an identical name. An old story about a time traveler who was constantly being reborn. An eccentric world that grows, cultivates, and uses Gu. The Spring Autumn Cicada, Moonlight Gu, Liquor worm, Comprehensive Golden Light Worm, Fine Black Hair Gu, Hope Gu. . . . . ', 4.7, 0, 'A dark tale of cultivation and strategy.', 'Action', 2334, 'reverend.jpg', 'https://www.youtube.com/embed/8sekyV_o2pM?si=pZFZdFum4W86D7MU'),
(9, 'Shadow Slave', 'Yoo Heon', 'Growing up in poverty, Sunny never expected anything good from life. However, even he did not anticipate being chosen by the Nightmare Spell and becoming one of the Awakened - an elite group of people gifted with supernatural powers. Transported into a ruined magical world, he found himself facing against terrible monsters - and other Awakened - in a deadly battle of survival. What\'s worse, the divine power he received happened to possess a small, but potentially fatal side effect...', 4.5, 0, 'A thrilling dark fantasy.', 'Fantasy', 2085, 'shadow slave.jpg', 'https://www.youtube.com/embed/aXwoeXetD4A?si=O3Y_fLOM2op3f6aq'),
(10, 'SSS-Class Suicide Hunter', 'Geun Lee', 'I want an S-Rank skill too! I want it so badly; I could die for it!  [You have awakened an S-Rank skill.] [But you die if you use this skill.] …But it’s not like I will really die because it says that, right. RIGHT?', 4.9, 0, 'An intense tale of survival and revenge.', 'Action', 491, 'suicide hunter.jpg', 'https://www.youtube.com/embed/Gj-jmBi0aK8?si=scg4a3SfbadoOv9h'),
(11, 'The Author\'s POV', 'Jin Shuang', 'The person whom the world revolves around.  The person who defeats all of his opponents, and ultimately gets the beautiful girl.  The sole existence all villains fear.', 4.5, 0, 'An intriguing story with a twist on the narrative.', 'Fantasy', 864, 'author\'s pov.jpg', 'https://www.youtube.com/embed/E2Rj2gQAyPA?si=08GjUCI0S3z-bytQ'),
